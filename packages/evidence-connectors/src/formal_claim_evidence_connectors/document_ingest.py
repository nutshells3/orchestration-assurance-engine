...
def role_to_semantic_type(role: str) -> str:
...
def trace_relation_to_canonical(relation: dict[str, Any]) -> dict[str, Any]:
    ...
    semantic_relation_type = SEMANTIC_RELATION_ALIASES.get(relation_type, "depends_on")
    candidate_type = INTERNAL_RELATION_ALIASES.get(semantic_relation_type, "depends_on")
    semantic_strength = str(relation.get("strength", "unknown") or "unknown")

    rationale_parts = [
        f"trace_relation={relation_type}",
        f"semantic_relation_type={semantic_relation_type}",
        f"semantic_strength={semantic_strength}",
    ]
    ...
    *,
    ...
    return {
        ...
        "tags": [
            ...
            f"{SEMANTIC_TYPE_PREFIX}{role_to_semantic_type(role)}",
