...
Use [`justfile`](justfile) as the top-level entrypoint:
...
- [managed-proof-runs.md](docs/architecture/managed-proof-runs.md)
- [formal-claim-stack-positioning.md](docs/architecture/formal-claim-stack-positioning.md)
- [fwp-seam-extraction-plan.md](docs/architecture/fwp-seam-extraction-plan.md)
- [operator-proof-run-controls.md](docs/policies/operator-proof-run-controls.md)
- [runtime-boundary-contract.md](docs/product/runtime-boundary-contract.md)
- [release-packaging.md](docs/product/release-packaging.md)
- [release-smoke-checklist.md](docs/product/release-smoke-checklist.md)
