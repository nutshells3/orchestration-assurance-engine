...
EXPECTED_SUBDIRS = [
    ...
    ".codex/skills",
    ".codex/skills/formal-claim-operator",
    ".codex/skills/formal-claim-release",
    ".claude/skills",
    ".claude/skills/formal-claim-operator",
    ".claude/skills/formal-claim-release",
    "apps/cli",
...
EXPECTED_FILES = [
    ...
    ".editorconfig",
    ".codex/config.toml",
    ".codex/skills/formal-claim-operator/SKILL.md",
    ".codex/skills/formal-claim-release/SKILL.md",
    ".claude/settings.local.json",
    ".claude/skills/formal-claim-operator/SKILL.md",
    ".claude/skills/formal-claim-release/SKILL.md",
    "package.json",
    "pnpm-lock.yaml",
    "pnpm-workspace.yaml",
    "pyproject.toml",
